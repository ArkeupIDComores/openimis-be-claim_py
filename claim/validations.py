...
def validate_claimdetail_limitation_fail(claim, claimdetail):
    ...
    print(f"voici la date_to du claim : {claim.date_to} et voici sa date_from du claim : {claim.date_from}")
    target_date = __get_claim_target_date(claim)
    logger.debug(f"voici la date cible : {target_date}")
    print(f"voici la date cible : {target_date}")
    logger.debug(f"voici la date de naissance de l'assuré : {claim.insuree.dob}")
    print(f"voici la date de naissance de l'assuré : {claim.insuree.dob}")
    ...
    print(f"C'est à partir de la date cible que l'on determine si l'assuré est adulte. Cette date de reference est soit la valeur du date_to du claim si elle existe soit celle du date_from sinon!!!")
    ...
    print(f"voici le masque de categorie calculé avant l'exception : {patient_category_mask}")
    ...
    print(f"Et voici le masque de categorie qui est dans les details du claim avant l'exception : {claimdetail.itemsvc.patient_category}")
    ...
    if claimdetail.itemsvc.patient_category & patient_category_mask != patient_category_mask:
        ...
        print(f"voici le masque de categorie dans l'exception qui est different de celui qui est dans les details du claim:{patient_category_mask}")
