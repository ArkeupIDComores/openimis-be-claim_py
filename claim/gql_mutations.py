                    ...
                    if claim_service:
                        ...
                        if service_element:
                            ...
                            if claim_service_to_update:
                                ...
                                service = Service.objects.get(id=service_id, validity_to__isnull=True)
...
class PrescriberBase:
    ...
    main_health_facility_id = graphene.Int(required=True)
    speciality_id = graphene.Int(required=False)
    status_id = graphene.Int(required=False)
    authorized_health_facilities = graphene.List(graphene.Int, required=False)
